  ...
  loadFromServer(pageSize) {
    ...
    follow(client, root, [{ rel: 'employees', params: { size: pageSize } }])
      ...
      .done(employeeCollection => {
        this.setState({
          employees: employeeCollection.entity._embedded.employee,
...
class EmployeeList extends React.Component {
  render() {
    const employees = this.props.employees.map(employee => <Employee key={ employee._links.self.href } employee={ employee } onDelete={ this.props.onDelete } />);
    ...
    return (
      <div>
        ...
        <div id="createEmployee" className="modalDialog">
          <div>
            <a href="#" title="Close" className="cloase">X</a>
